...
public class EditBoleta extends javax.swing.JFrame {    
    ...
    public void setApplication(Application frame) {
        this.frame = frame;
        editOptions1.setApplication(frame);
    }
    
    public void initData(Boleta boleta) {
        editOptions1.setData(boleta);
    }
    ...
    private void initComponents() {
        ...
        editOptions1 = new UI.Ventas.EditBoletaOptions();
        ...
        jScrollPane1.setViewportView(editOptions1);
            ...
            .addGroup(simpleBackground1Layout.createSequentialGroup()
                .addGroup(simpleBackground1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(simpleBackground1Layout.createSequentialGroup()
                        ...
                        .addComponent(customButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(simpleBackground1Layout.createSequentialGroup()
                        .addGap(15, 15, 15)
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        try {
            frame.findBoletaById(editOptions1.getCodigo()).setComentario(editOptions1.getComentario());
            frame.getVentas().updateBoleta(index, frame.findBoletaById(editOptions1.getCodigo()));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditBoleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        
        java.awt.EventQueue.invokeLater(() -> {
            new EditBoleta().setVisible(true);
        });
    }
    ...
    private UI.Ventas.EditBoletaOptions editOptions1;
