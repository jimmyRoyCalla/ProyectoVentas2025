...
public class AddBoleta extends javax.swing.JFrame {
    private Application frame;
    
    public AddBoleta() {
        initComponents();
        setBackground(new Color(0, 0, 0, 0));
        initMoving(AddBoleta.this);
    ...
    public void setApplication(Application frame) {
        ...
        options1.setParent(this);
    }
    
    public UI.Ventas.AddBoletaOptions getOptions() {
        return options1;
    }
    ...
    private void initComponents() {
        ...
        options1 = new UI.Ventas.AddBoletaOptions();
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (!options1.isTableEmpty()) {
            try {
                Boleta boleta = options1.getBoleta();
                
                for (Object[] producto : boleta.getProductos()) {
                    Producto producto_original = frame.findProductoByCodigo((int) producto[0]);
                    int cantidad = producto_original.getCantidad() - ((int) producto[1]);
                    producto_original.setCantidad(cantidad);
                }
                
                frame.getProductos().updateCantidadProducto();
                frame.getVentas().addBoleta(boleta);
            } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBoleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        java.awt.EventQueue.invokeLater(() -> {
            new AddBoleta().setVisible(true);
        });
    }
    ...
    private UI.Ventas.AddBoletaOptions options1;
