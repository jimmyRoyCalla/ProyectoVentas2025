...
public class AddFactura extends javax.swing.JFrame {
    ...
    public UI.Ventas.AddFacturaOptions getOptions() {
        return options1;
    }
    ...
    private void initComponents() {
        ...
        options1 = new UI.Ventas.AddFacturaOptions();
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (!options1.isTableEmpty()) {
            try {
                Factura factura = options1.getFactura();
                ...
                frame.getVentas().addFactura(factura);
            } 
    ...
    private UI.Ventas.AddFacturaOptions options1;
