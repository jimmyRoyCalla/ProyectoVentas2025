...
public class ViewBoleta extends javax.swing.JFrame {    
    private Application frame;
    
    public ViewBoleta() {
        initComponents();
        setBackground(new Color(0, 0, 0, 0));
        initMoving(ViewBoleta.this);
    ...
    private void initComponents() {
        ...
        viewOptions1 = new UI.Ventas.ViewBoletaOptions();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBoleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        java.awt.EventQueue.invokeLater(() -> {
            new ViewBoleta().setVisible(true);
        });
    }
    ...
    private UI.Ventas.ViewBoletaOptions viewOptions1;
