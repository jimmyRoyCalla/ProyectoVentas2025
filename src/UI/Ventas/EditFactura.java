...
public class EditFactura extends javax.swing.JFrame {    
    ...
    private void initComponents() {
        ...
        editOptions1 = new UI.Ventas.EditFacturaOptions();
        ...
        jLabel1.setText("     Editar Factura (comentario)");
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        try {
            frame.findFacturaById(editOptions1.getCodigo()).setComentario(editOptions1.getComentario());
            frame.getVentas().updateFactura(index, frame.findFacturaById(editOptions1.getCodigo()));
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new EditFactura().setVisible(true);
        });
    }
    ...
    private UI.Ventas.EditFacturaOptions editOptions1;
