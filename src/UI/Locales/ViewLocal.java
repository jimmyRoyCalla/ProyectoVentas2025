...
public class ViewLocal extends javax.swing.JFrame {    
    ...
    public void initData() {
        Object[] data = new Object[] { String.valueOf(local.getCodigo()), local.getDireccion(), local.getTelefono(), local.getComentario()};
        viewOptions1.setData(data);
        viewOptions1.setProductos(local.getProductos());
        viewOptions1.setEmpleados(local.getEmpleados());
    }
    ...
    private void initComponents() {
        ...
        viewOptions1 = new UI.Locales.ViewOptions();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewLocal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        java.awt.EventQueue.invokeLater(() -> {
            new ViewLocal().setVisible(true);
        });
    }
    ...
    private UI.Locales.ViewOptions viewOptions1;
