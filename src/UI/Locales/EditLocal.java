...
public class EditLocal extends javax.swing.JFrame {
    ...
    public void setLocal(Local local) {
        options1.setLocal(local);
    }
    
    public void initData() {
        options1.setData();
        options1.setProductos();
        options1.setEmpleados();
    }
    ...
    private void initComponents() {
        ...
        options1 = new UI.Locales.Options();
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (options1.isLegal()) {
            ...
            local.setCodigo(Integer.parseInt((String) data[0]));
            local.setDireccion((String) data[1]);
            local.setTelefono((String) data[2]);
            local.setComentario((String) data[3]);
            local.setProductos((ArrayList<Integer>) data[4]);
            local.setEmpleados((ArrayList<String>) data[5]);
            
            try {
                frame.getLocales().updateLocal(index, local);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditLocal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        
        java.awt.EventQueue.invokeLater(() -> {
            new EditLocal().setVisible(true);
        });
    }
    ...
    private UI.Locales.Options options1;
