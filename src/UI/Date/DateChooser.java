...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new UI.Date.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new UI.Date.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new UI.Date.Button();
        cmdPrevious = new UI.Date.Button();
        slide = new UI.Date.Slider();
    ...
    private UI.Date.Button cmdForward;
    private UI.Date.Button cmdMonth;
    private UI.Date.Button cmdPrevious;
    private UI.Date.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private UI.Date.Slider slide;
