...
public class ViewEmpleado extends javax.swing.JFrame {    
    ...
    public void initData() {
        ...
        String format_fecha = date_format.format(empleado.getFechaNacimiento());
        
        String direccion;
        if (empleado.getLocalAsignado() == null) direccion = "Ninguno";
        else direccion = frame.findLocalByCodigo(empleado.getLocalAsignado()).getDireccion();
        
        Object[] data = new Object[] { empleado.getDni(), empleado.getNombres(), empleado.getApellidos(), empleado.getTelefono(),
                                       empleado.getEstadoCivil(), empleado.getDireccion(), format_fecha, empleado.getCargo(),
                                       "S/ " + String.valueOf(empleado.getSalario()), direccion };
    ...
    private void initComponents() {
        ...
        viewOptions1 = new UI.Empleados.ViewOptions();
    ...
    private UI.Empleados.ViewOptions viewOptions1;
