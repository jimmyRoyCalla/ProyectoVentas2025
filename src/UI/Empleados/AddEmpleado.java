    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (options1.isLegal()) {
            try {
                ...
                if (data[9] == null) empleado.setLocalAsignado(null);
                else empleado.setLocalAsignado((Integer) data[9]);
                
                frame.getEmpleados().addEmpleado(empleado);
