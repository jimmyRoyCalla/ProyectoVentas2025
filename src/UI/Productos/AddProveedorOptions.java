...
public class AddProveedorOptions extends javax.swing.JPanel {
    private Proveedor proveedor;
    
    public AddProveedorOptions() {
        initComponents();
        setInvisible();
    }
    ...
    public Producto getProducto() {
        ...
        producto.setNombre(hintedText2.getText());
        producto.setPrecio(Double.parseDouble(hintedText3.getText()));
        producto.setCantidad(Integer.parseInt(hintedText4.getText()));
        producto.setProveedor(proveedor.getCodigo());
    ...
    public void setProveedor(Proveedor proveedor) {
        ...
        hintedText5.setText(proveedor.getNombre());
    }
    ...
    private void initComponents() {
        ...
        hintedText5 = new javax.swing.JLabel();
        ...
        hintedText5.setForeground(new java.awt.Color(153, 153, 153));
        hintedText5.setText("Proveedor");
    ...
    private javax.swing.JLabel hintedText5;
