...
public class EditProducto extends javax.swing.JFrame {
    ...
    private Producto producto_editar;
    private int index;
    
    public EditProducto() {
        initComponents();
        setBackground(new Color(0, 0, 0, 0));
        initMoving(EditProducto.this);
    ...
    public void initData() {
        Object[] data = new Object[] { String.valueOf(producto_editar.getCodigo()), producto_editar.getNombre(), String.valueOf(producto_editar.getPrecio()), 
                                       String.valueOf(producto_editar.getCantidad()), frame.findProveedorByCodigo(producto_editar.getProveedor()).getNombre() };
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (options1.isLegal()) {
            ...
            producto.setCodigo(Integer.parseInt((String) data[0]));
            ...
            if ((int) data[4] != producto_editar.getProveedor()) {
                frame.findProveedorByCodigo(producto_editar.getProveedor()).getProductos().remove((Integer) producto_editar.getCodigo());
                frame.findProveedorByCodigo((int) data[4]).getProductos().add(producto.getCodigo());
            }
            
            producto.setProveedor((int) data[4]);

            try {
                frame.getProductos().updateProducto(index, producto);
            } 
