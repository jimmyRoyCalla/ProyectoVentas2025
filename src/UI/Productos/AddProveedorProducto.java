...
public class AddProveedorProducto extends javax.swing.JFrame {
    private Application frame;
    
    public AddProveedorProducto() {
        initComponents();
        setBackground(new Color(0, 0, 0, 0));
        initMoving(AddProveedorProducto.this);
    ...
    private void initComponents() {
        ...
        options1 = new UI.Productos.AddProveedorOptions();
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (options1.isLegal()) {
            Producto producto = options1.getProducto();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddProveedorProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        java.awt.EventQueue.invokeLater(() -> {
            new AddProveedorProducto().setVisible(true);
        });
    }
    ...
    private UI.Productos.AddProveedorOptions options1;
