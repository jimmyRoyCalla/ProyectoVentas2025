...
public class EditProveedor extends javax.swing.JFrame {
    ...
    public void setProveedor(Proveedor proveedor) {
        options1.setProveedor(proveedor);
    }
    
    public void initData() {
        options1.setData();
        options1.setProductos();
    }
    ...
    private void initComponents() {
        ...
        options1 = new UI.Proveedores.EditOptions();
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (options1.isLegal()) {
            ...
            proveedor.setCodigo(Integer.parseInt((String) data[0]));
            proveedor.setNombre((String) data[1]);
            proveedor.setTelefono((String) data[2]);
            proveedor.setDescuento(Double.parseDouble((String) data[3]) / 100);
            proveedor.setProductos((ArrayList<Integer>) data[4]);
            
            try {
                frame.getProveedores().updateProveedor(index, proveedor);
            } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        java.awt.EventQueue.invokeLater(() -> {
            new EditProveedor().setVisible(true);
        });
    }
    ...
    private UI.Proveedores.EditOptions options1;
