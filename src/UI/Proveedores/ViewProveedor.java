...
public class ViewProveedor extends javax.swing.JFrame {    
    ...
    public void initData() {
        Object[] data = new Object[] { String.valueOf(proveedor.getCodigo()), proveedor.getNombre(), proveedor.getTelefono(), String.valueOf(proveedor.getDescuento() * 100) + "%" };
        viewOptions1.setData(data);
        viewOptions1.setProductos(proveedor.getProductos());
    }
    ...
    private void initComponents() {
        ...
        viewOptions1 = new UI.Proveedores.ViewOptions();
    ...
    private UI.Proveedores.ViewOptions viewOptions1;
