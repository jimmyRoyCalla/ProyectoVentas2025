...
public class ViewCliente extends javax.swing.JFrame {    
    ...
    public void initData() {
        ...
        String format_fecha = date_format.format(cliente.getFechaNacimiento());
        
        Object[] data = new Object[] { cliente.getDni(), cliente.getNombres(), cliente.getApellidos(), cliente.getTelefono(),
                                       cliente.getEstadoCivil(), cliente.getDireccion(), format_fecha, cliente.getMembresia() };
    ...
    private void initComponents() {
        ...
        viewOptions1 = new UI.Clientes.ViewClienteOptions();
    ...
    private UI.Clientes.ViewClienteOptions viewOptions1;
