...
public class EditCliente extends javax.swing.JFrame {
    ...
    public void initData() {
        ...
        String format_fecha = date_format.format(cliente_editar.getFechaNacimiento());
        
        Object[] data = new Object[] { cliente_editar.getDni(), cliente_editar.getNombres(), cliente_editar.getApellidos(), cliente_editar.getTelefono(),
                                       cliente_editar.getEstadoCivil(), cliente_editar.getDireccion(), format_fecha, cliente_editar.getMembresia() }; 
    ...
    private void initComponents() {
        ...
        options1 = new UI.Clientes.ClienteOptions();
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (options1.isLegal()) {
            try {
                ...
                cliente.setDni(cliente_editar.getDni());
                cliente.setNombres((String) data[1]);
                cliente.setApellidos((String) data[2]);
                cliente.setTelefono((String) data[3]);
                cliente.setEstadoCivil((String) data[4]);
                cliente.setDireccion((String) data[5]);
                cliente.setFechaNacimiento(new SimpleDateFormat("dd-MM-yyyy").parse((String) data[6]));
                cliente.setMembresia((String) data[7]);
                
                frame.getClientes().updateCliente(index, cliente);
    ...
    private UI.Clientes.ClienteOptions options1;
