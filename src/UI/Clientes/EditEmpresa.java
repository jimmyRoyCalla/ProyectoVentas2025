...
public class EditEmpresa extends javax.swing.JFrame {
    private Application frame;
    private Empresa empresa_editar;
    private int index;
    
    public EditEmpresa() {
        initComponents();
        setBackground(new Color(0, 0, 0, 0));
        initMoving(EditEmpresa.this);
        ...
        options1.getRucTextBox().setEditable(false);
    }
    ...
    public void initData() {
        Object[] data = new Object[] { empresa_editar.getRUC(), empresa_editar.getNombre(), empresa_editar.getDireccion(), empresa_editar.getTelefono() }; 
    ...
    private void initComponents() {
        ...
        options1 = new UI.Clientes.EmpresaOptions();
    ...
    private void customButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton1ActionPerformed
        if (options1.isLegal()) {
            try {
                ...
                empresa.setRUC(empresa_editar.getRUC());
                empresa.setNombre((String) data[1]);
                empresa.setDireccion((String) data[2]);
                empresa.setTelefono((String) data[3]);
                
                frame.getClientes().updateEmpresa(index, empresa);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
    ...
    private UI.Clientes.EmpresaOptions options1;
